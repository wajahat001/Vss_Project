...
const variants = {
  primary: 'bg-grad text-[#0b0c12] shadow-btn-primary hover:shadow-btn-primary-hover hover:-translate-y-px hover:scale-[1.01]',
  secondary: 'bg-transparent text-text-0 border border-violet/50 hover:bg-violet/10 hover:border-violet',
  ghost: 'bg-transparent text-text-1 hover:bg-white/5 hover:text-text-0',
...
export default function Button({
  ...
  return (
    <button
      disabled={disabled}
      className={[
        'inline-flex items-center justify-center gap-2 rounded-btn font-semibold border border-transparent',
